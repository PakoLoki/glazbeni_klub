...
<head>
    ...
    <meta name="description" content="12.4.2022.">
...
<body id="navigacija">
    ...
    <main>
        <div class="slikanav">
            <a href="Materijali/navigacijski dijagram.drawio.png">
                <img src="Materijali/navigacijski dijagram.drawio.png" width="200" height="200" alt="navigacijski">
            </a>
        </div>
    </main>
    <footer>
